    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <img src="<?php echo nn_asset( 'assets/images/niconat-logo.webp' ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
          <div class="footer-brand-location">Los Angeles</div>
          <p>We design, engineer, and manufacture retail environments that bring ideas to life &mdash; combining craftsmanship, technology, and precision.</p>
        </div>
        <div>
          <h4>Company</h4>
          <ul class="footer-links">
            <li><a href="<?php echo nn_anchor( 'about' ); ?>">About Us</a></li>
            <li><a href="<?php echo nn_anchor( 'portfolio' ); ?>">Our Work</a></li>
            <li><a href="<?php echo nn_anchor( 'services' ); ?>">Services</a></li>
            <li><a href="<?php echo esc_url( nn_finishes_url() ); ?>">Finishes</a></li>
          </ul>
        </div>
        <div>
          <h4>Contact</h4>
          <div class="footer-contact-item"><a href="mailto:info@niconat.co">info@niconat.co</a></div>
          <div class="footer-contact-item"><a href="tel:+13237211900">(323) 721-1900</a></div>
      ...
      <div class="footer-bottom">
        <p>DESIGNED BY THE CLAY MEDIA &copy; <?php echo esc_html( gmdate( 'Y' ) ); ?></p>
...
<?php if ( nn_is_finishes() ) : ?>
  <?php get_template_part( 'parts/swatch', 'modal' ); ?>
<?php endif; ?>
