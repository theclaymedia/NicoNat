...
<?php else : ?>
      <form class="sample-form" id="sampleForm" novalidate>
        ...
        <div class="finish-group">
          ...
          <p class="sample-note">Partnership Collection materials &mdash; stone, glass, mirror, leather, integrated lighting, and acrylic &mdash; are sampled <strong>directly by our partner vendors</strong>. Open any partnership finish above and use its vendor link to request samples.</p>
        </div>
